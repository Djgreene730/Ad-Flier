...
SIGNAL \Registers|RegAM|tmp[4]~feeder_combout\ : std_logic;
...
SIGNAL \Registers|RegAdd|tmp[0]~feeder_combout\ : std_logic;
...
SIGNAL \Registers|RegYD|tmp[0]~feeder_combout\ : std_logic;
...
SIGNAL \Registers|RegAD|tmp[3]~feeder_combout\ : std_logic;
...
SIGNAL \Registers|RegAD|tmp[4]~feeder_combout\ : std_logic;
SIGNAL \Registers|databus[4]~9_combout\ : std_logic;
SIGNAL \Registers|MuxOut|tmp1[4]~4_combout\ : std_logic;
SIGNAL \Registers|RegYD|tmp[5]~feeder_combout\ : std_logic;
...
SIGNAL \Registers|RegZD|tmp[6]~feeder_combout\ : std_logic;
...
SIGNAL \U_PICSPI_Slave|MOSIr[0]~feeder_combout\ : std_logic;
...
SIGNAL \Registers|RegCont|state.wd2~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \U_1HzClkDivider|Equal0~2_combout\ = (!\U_1HzClkDivider|cnt\(10) & (!\U_1HzClkDivider|cnt\(8) & (\U_1HzClkDivider|cnt\(11) & !\U_1HzClkDivider|cnt\(9))))
...
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegAM|tmp[4]~feeder_combout\,
	aclr => \Switch_2~combout\,
	ena => \Registers|RegCont|regi07~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataa => \U_PICSPI_Slave|Add1~0_combout\,
...
PORT MAP (
	...
	datac => \U_PICSPI_Slave|byte_data_sent\(4),
	datad => \U_PICSPI_Slave|byte_data_sent~0_combout\,
...
-- Equation(s):
-- \Registers|RegCont|nextstate.rd1~0_combout\ = (!\PIC_PBUS_A_D~combout\ & (\PIC_PBUS_OK_IN~combout\ & (!\Registers|RegCont|state.fetch~regout\ & \PIC_PBUS_R_W~combout\)))
...
-- Equation(s):
-- \U_PICSPI_Slave|byte_data_sent~5_combout\ = (\U_PICSPI_Slave|Equal2~0_combout\ & ((\U_PICSPI_Slave|cnt\(4)) # ((\U_PICSPI_Slave|byte_data_sent\(3) & !\U_PICSPI_Slave|byte_data_sent~0_combout\)))) # (!\U_PICSPI_Slave|Equal2~0_combout\ & 
...
PORT MAP (
	...
	datac => \U_PICSPI_Slave|byte_data_sent\(3),
	datad => \U_PICSPI_Slave|byte_data_sent~0_combout\,
...
-- Equation(s):
-- \U_PICSPI_Slave|byte_data_sent~8_combout\ = (\U_PICSPI_Slave|byte_data_sent\(0) & (((\U_PICSPI_Slave|Equal2~0_combout\ & \U_PICSPI_Slave|cnt\(1))) # (!\U_PICSPI_Slave|byte_data_sent~0_combout\))) # (!\U_PICSPI_Slave|byte_data_sent\(0) & 
-- (\U_PICSPI_Slave|Equal2~0_combout\ & (\U_PICSPI_Slave|cnt\(1))))
...
-- Equation(s):
-- \U_PICSPI_Slave|byte_data_sent[0]~10_combout\ = (\U_PICSPI_Slave|Equal2~0_combout\ & ((\U_PICSPI_Slave|byte_data_sent[0]~9_combout\) # ((!\U_PICSPI_Slave|byte_data_sent[0]~2_combout\ & \U_PICSPI_Slave|byte_data_sent\(0))))) # 
-- (!\U_PICSPI_Slave|Equal2~0_combout\ & (!\U_PICSPI_Slave|byte_data_sent[0]~2_combout\ & (\U_PICSPI_Slave|byte_data_sent\(0))))
...
PORT MAP (
	dataa => \U_PICSPI_Slave|Equal2~0_combout\,
	datab => \U_PICSPI_Slave|byte_data_sent[0]~2_combout\,
...
-- Equation(s):
-- \Registers|RegAM|tmp[0]~feeder_combout\ = \PIC_PBUS_Data[0]~0\
...
-- Equation(s):
-- \Registers|RegXM|tmp[1]~feeder_combout\ = \PIC_PBUS_Data[1]~1\
...
-- Equation(s):
-- \Registers|RegAM|tmp[3]~feeder_combout\ = \PIC_PBUS_Data[3]~3\
...
\Registers|RegAM|tmp[4]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegAM|tmp[4]~feeder_combout\ = \PIC_PBUS_Data[4]~4\
...
-- pragma translate_on
PORT MAP (
	datad => \PIC_PBUS_Data[4]~4\,
	combout => \Registers|RegAM|tmp[4]~feeder_combout\);

-- Location: LCCOMB_X26_Y18_N28
\Registers|RegXM|tmp[5]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegXM|tmp[5]~feeder_combout\ = \PIC_PBUS_Data[5]~5\
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegCont|state.rd1~regout\,
	datab => \PIC_PBUS_OK_IN~combout\,
...
-- Equation(s):
-- \Registers|RegCont|state.ra1~0_combout\ = (\PIC_PBUS_A_D~combout\ & (\PIC_PBUS_OK_IN~combout\ & (!\Registers|RegCont|state.fetch~regout\ & \PIC_PBUS_R_W~combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegCont|ok_in~combout\,
	datab => \PIC_PBUS_OK_IN~combout\,
	datac => \Registers|RegCont|state.fetch~regout\,
...
-- Equation(s):
-- \Registers|RegCont|nextstate.wa1~0_combout\ = (\PIC_PBUS_A_D~combout\ & (\PIC_PBUS_OK_IN~combout\ & (!\Registers|RegCont|state.fetch~regout\ & !\PIC_PBUS_R_W~combout\)))
...
\Registers|RegAdd|tmp[0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegAdd|tmp[0]~feeder_combout\ = \PIC_PBUS_Data[0]~0\
...
PORT MAP (
	datad => \PIC_PBUS_Data[0]~0\,
	combout => \Registers|RegAdd|tmp[0]~feeder_combout\);

-- Location: LCFF_X25_Y18_N9
\Registers|RegAdd|tmp[0]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegAdd|tmp[0]~feeder_combout\,
	aclr => \Switch_2~combout\,
	ena => \Registers|RegCont|state.wa1~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Registers|RegCont|nextstate.wd1~0_combout\ = (!\PIC_PBUS_A_D~combout\ & (\PIC_PBUS_OK_IN~combout\ & (!\Registers|RegCont|state.fetch~regout\ & !\PIC_PBUS_R_W~combout\)))
...
-- Equation(s):
-- \Registers|RegCont|regi06~0_combout\ = (\Registers|RegCont|regi07~0_combout\ & (!\Registers|RegAdd|tmp\(3) & (\Registers|RegAdd|tmp\(2) & \Registers|RegCont|state.wd1~regout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegCont|regi07~0_combout\,
...
-- Equation(s):
-- \Registers|databus[0]~1_combout\ = (\Registers|RegAM|tmp\(0)) # ((\Registers|RegAD|tmp\(0)) # ((\Registers|RegYM|tmp\(0)) # (\Registers|RegZM|tmp\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegAM|tmp\(0),
	datab => \Registers|RegAD|tmp\(0),
	datac => \Registers|RegYM|tmp\(0),
	datad => \Registers|RegZM|tmp\(0),
	combout => \Registers|databus[0]~1_combout\);

-- Location: LCCOMB_X25_Y18_N0
\Registers|RegCont|regi03~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegCont|regi03~0_combout\ = (\Registers|RegCont|regi07~0_combout\ & (!\Registers|RegAdd|tmp\(2) & (!\Registers|RegAdd|tmp\(3) & \Registers|RegCont|state.wd1~regout\)))
...
\Registers|RegYD|tmp[0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegYD|tmp[0]~feeder_combout\ = \PIC_PBUS_Data[0]~0\
...
PORT MAP (
	datad => \PIC_PBUS_Data[0]~0\,
	combout => \Registers|RegYD|tmp[0]~feeder_combout\);
...
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegYD|tmp[0]~feeder_combout\,
	aclr => \Switch_2~combout\,
...
-- Equation(s):
-- \Registers|databus[0]~0_combout\ = (\Registers|RegXM|tmp\(0)) # ((\Registers|RegZD|tmp\(0)) # ((\Registers|RegXD|tmp\(0)) # (\Registers|RegYD|tmp\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegXM|tmp\(0),
	datab => \Registers|RegZD|tmp\(0),
	datac => \Registers|RegXD|tmp\(0),
	datad => \Registers|RegYD|tmp\(0),
...
-- Equation(s):
-- \Registers|databus[1]~3_combout\ = (\Registers|RegAD|tmp\(1)) # ((\Registers|RegAM|tmp\(1)) # ((\Registers|RegYM|tmp\(1)) # (\Registers|RegZM|tmp\(1))))
...
PORT MAP (
	...
	datab => \Registers|RegAdd|tmp\(1),
	datac => \Registers|databus[1]~2_combout\,
	datad => \Registers|RegCont|state.ra1~regout\,
...
-- Equation(s):
-- \Registers|databus[2]~4_combout\ = (\Registers|RegXM|tmp\(2)) # ((\Registers|RegZD|tmp\(2)) # ((\Registers|RegXD|tmp\(2)) # (\Registers|RegYD|tmp\(2))))
...
-- Equation(s):
-- \Registers|databus[2]~5_combout\ = (\Registers|RegAD|tmp\(2)) # ((\Registers|RegAM|tmp\(2)) # ((\Registers|RegYM|tmp\(2)) # (\Registers|RegZM|tmp\(2))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegAD|tmp\(2),
	datab => \Registers|RegAM|tmp\(2),
...
-- Equation(s):
-- \Registers|MuxOut|tmp1[2]~2_combout\ = (\Registers|RegCont|state.ra1~regout\ & (((\Registers|RegAdd|tmp\(2))))) # (!\Registers|RegCont|state.ra1~regout\ & ((\Registers|databus[2]~4_combout\) # ((\Registers|databus[2]~5_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|databus[2]~4_combout\,
...
-- Equation(s):
-- \Registers|databus[3]~6_combout\ = (\Registers|RegXM|tmp\(3)) # ((\Registers|RegZD|tmp\(3)) # ((\Registers|RegXD|tmp\(3)) # (\Registers|RegYD|tmp\(3))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegXM|tmp\(3),
	datab => \Registers|RegZD|tmp\(3),
	datac => \Registers|RegXD|tmp\(3),
	datad => \Registers|RegYD|tmp\(3),
	combout => \Registers|databus[3]~6_combout\);

-- Location: LCCOMB_X24_Y17_N28
\Registers|RegAD|tmp[3]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegAD|tmp[3]~feeder_combout\ = \PIC_PBUS_Data[3]~3\
...
PORT MAP (
	datad => \PIC_PBUS_Data[3]~3\,
	combout => \Registers|RegAD|tmp[3]~feeder_combout\);

-- Location: LCFF_X24_Y17_N29
\Registers|RegAD|tmp[3]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegAD|tmp[3]~feeder_combout\,
	aclr => \Switch_2~combout\,
	ena => \Registers|RegCont|regi06~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Registers|MuxOut|tmp1[3]~3_combout\ = (\Registers|RegCont|state.ra1~regout\ & (\Registers|RegAdd|tmp\(3))) # (!\Registers|RegCont|state.ra1~regout\ & (((\Registers|databus[3]~6_combout\) # (\Registers|databus[3]~7_combout\))))
...
PORT MAP (
	...
	datac => \Registers|databus[3]~7_combout\,
	datad => \Registers|RegCont|state.ra1~regout\,
...
-- Equation(s):
-- \Registers|RegCont|regi03~1_combout\ = (\Registers|RegAdd|tmp\(0) & (\Registers|RegAdd|tmp\(1) & \Registers|RegCont|regi03~0_combout\))
...
-- Equation(s):
-- \Registers|databus[4]~8_combout\ = (\Registers|RegZD|tmp\(4)) # ((\Registers|RegXM|tmp\(4)) # ((\Registers|RegXD|tmp\(4)) # (\Registers|RegYD|tmp\(4))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegZD|tmp\(4),
	datab => \Registers|RegXM|tmp\(4),
...
\Registers|RegAD|tmp[4]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegAD|tmp[4]~feeder_combout\ = \PIC_PBUS_Data[4]~4\
...
PORT MAP (
	datad => \PIC_PBUS_Data[4]~4\,
	combout => \Registers|RegAD|tmp[4]~feeder_combout\);

-- Location: LCFF_X24_Y17_N9
\Registers|RegAD|tmp[4]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegAD|tmp[4]~feeder_combout\,
	aclr => \Switch_2~combout\,
	ena => \Registers|RegCont|regi06~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Registers|databus[4]~9_combout\ = (\Registers|RegAM|tmp\(4)) # ((\Registers|RegAD|tmp\(4)) # ((\Registers|RegYM|tmp\(4)) # (\Registers|RegZM|tmp\(4))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegAM|tmp\(4),
	datab => \Registers|RegAD|tmp\(4),
	datac => \Registers|RegYM|tmp\(4),
	datad => \Registers|RegZM|tmp\(4),
...
PORT MAP (
	...
	datad => \Registers|databus[4]~9_combout\,
...
\Registers|RegYD|tmp[5]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegYD|tmp[5]~feeder_combout\ = \PIC_PBUS_Data[5]~5\
...
PORT MAP (
	datad => \PIC_PBUS_Data[5]~5\,
	combout => \Registers|RegYD|tmp[5]~feeder_combout\);

-- Location: LCFF_X26_Y18_N19
\Registers|RegYD|tmp[5]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegYD|tmp[5]~feeder_combout\,
	aclr => \Switch_2~combout\,
	ena => \Registers|RegCont|regi01~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Registers|databus[5]~11_combout\ = (\Registers|RegAM|tmp\(5)) # ((\Registers|RegAD|tmp\(5)) # ((\Registers|RegYM|tmp\(5)) # (\Registers|RegZM|tmp\(5))))
...
\Registers|RegZD|tmp[6]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegZD|tmp[6]~feeder_combout\ = \PIC_PBUS_Data[6]~6\
...
PORT MAP (
	datad => \PIC_PBUS_Data[6]~6\,
	combout => \Registers|RegZD|tmp[6]~feeder_combout\);

-- Location: LCFF_X24_Y18_N27
\Registers|RegZD|tmp[6]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegZD|tmp[6]~feeder_combout\,
	aclr => \Switch_2~combout\,
	ena => \Registers|RegCont|regi02~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Registers|databus[6]~12_combout\ = (\Registers|RegXM|tmp\(6)) # ((\Registers|RegYD|tmp\(6)) # ((\Registers|RegXD|tmp\(6)) # (\Registers|RegZD|tmp\(6))))
...
-- Equation(s):
-- \Registers|databus[6]~13_combout\ = (\Registers|RegAM|tmp\(6)) # ((\Registers|RegAD|tmp\(6)) # ((\Registers|RegYM|tmp\(6)) # (\Registers|RegZM|tmp\(6))))
...
PORT MAP (
	...
	datad => \Registers|RegZM|tmp\(6),
	combout => \Registers|databus[6]~13_combout\);

-- Location: LCCOMB_X28_Y18_N8
\Registers|MuxOut|tmp1[6]~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|MuxOut|tmp1[6]~6_combout\ = (\Registers|RegCont|state.ra1~regout\ & (((\Registers|RegAdd|tmp\(6))))) # (!\Registers|RegCont|state.ra1~regout\ & ((\Registers|databus[6]~12_combout\) # ((\Registers|databus[6]~13_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|databus[6]~12_combout\,
	datab => \Registers|RegAdd|tmp\(6),
	datac => \Registers|databus[6]~13_combout\,
	datad => \Registers|RegCont|state.ra1~regout\,
...
-- Equation(s):
-- \Registers|databus[7]~14_combout\ = (\Registers|RegZD|tmp\(7)) # ((\Registers|RegYD|tmp\(7)) # ((\Registers|RegXD|tmp\(7)) # (\Registers|RegXM|tmp\(7))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|RegZD|tmp\(7),
	datab => \Registers|RegYD|tmp\(7),
...
-- Equation(s):
-- \Registers|MuxOut|tmp1[7]~7_combout\ = (\Registers|RegCont|state.ra1~regout\ & (((\Registers|RegAdd|tmp\(7))))) # (!\Registers|RegCont|state.ra1~regout\ & ((\Registers|databus[7]~14_combout\) # ((\Registers|databus[7]~15_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Registers|databus[7]~14_combout\,
	datab => \Registers|RegCont|state.ra1~regout\,
	datac => \Registers|RegAdd|tmp\(7),
	datad => \Registers|databus[7]~15_combout\,
...
-- Equation(s):
-- \U_1HzClkDivider|cnt~10_combout\ = (\U_1HzClkDivider|Add0~0_combout\ & ((!\U_1HzClkDivider|Equal0~4_combout\) # (!\U_1HzClkDivider|Equal0~6_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_1HzClkDivider|Add0~2_combout\,
	datac => \U_1HzClkDivider|Equal0~6_combout\,
	datad => \U_1HzClkDivider|Equal0~4_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \U_1HzClkDivider|Add0~8_combout\,
	datac => \U_1HzClkDivider|Equal0~6_combout\,
	datad => \U_1HzClkDivider|Equal0~4_combout\,
...
-- Equation(s):
-- \U_1HzClkDivider|cnt~5_combout\ = (\U_1HzClkDivider|Add0~12_combout\ & ((!\U_1HzClkDivider|Equal0~6_combout\) # (!\U_1HzClkDivider|Equal0~4_combout\)))
...
-- Equation(s):
-- \U_1HzClkDivider|cnt~4_combout\ = (\U_1HzClkDivider|Add0~14_combout\ & ((!\U_1HzClkDivider|Equal0~6_combout\) # (!\U_1HzClkDivider|Equal0~4_combout\)))
...
PORT MAP (
	datab => \U_1HzClkDivider|Equal0~6_combout\,
	datac => \U_1HzClkDivider|Add0~22_combout\,
	datad => \U_1HzClkDivider|Equal0~4_combout\,
...
-- Equation(s):
-- \U_1HzClkDivider|Equal0~6_combout\ = (\U_1HzClkDivider|cnt\(22) & (\U_1HzClkDivider|cnt\(21) & (\U_1HzClkDivider|Equal0~5_combout\ & !\U_1HzClkDivider|cnt\(20))))
...
\U_PICSPI_Slave|MOSIr[0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \U_PICSPI_Slave|MOSIr[0]~feeder_combout\ = \PIC_SPI_MOSI~combout\
...
-- pragma translate_on
PORT MAP (
	datad => \PIC_SPI_MOSI~combout\,
	combout => \U_PICSPI_Slave|MOSIr[0]~feeder_combout\);

-- Location: LCFF_X5_Y16_N31
\U_PICSPI_Slave|MOSIr[0]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \U_PICSPI_Slave|MOSIr[0]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \BLED_Blue[0]~reg0feeder_combout\ = \PIC_PBUS_Data[4]~4\
...
-- Equation(s):
-- \BLED_Blue[3]~reg0feeder_combout\ = \PIC_PBUS_Data[7]~7\
...
-- Equation(s):
-- \BLED_Orange[1]~reg0feeder_combout\ = \PIC_PBUS_Data[1]~1\
...
-- Equation(s):
-- \BLED_Orange[2]~reg0feeder_combout\ = \PIC_PBUS_Data[2]~2\
...
-- Equation(s):
-- \BLED_Orange[3]~reg0feeder_combout\ = \PIC_PBUS_Data[3]~3\
...
\Registers|RegCont|state.wd2~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Registers|RegCont|state.wd2~feeder_combout\ = \Registers|RegCont|state.wd1~regout\
...
PORT MAP (
	datad => \Registers|RegCont|state.wd1~regout\,
	combout => \Registers|RegCont|state.wd2~feeder_combout\);

-- Location: LCFF_X28_Y18_N27
\Registers|RegCont|state.wd2\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \Registers|RegCont|state.wd2~feeder_combout\,
	aclr => \Switch_2~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \U_PICSPI_Slave|cnt[7]~19_combout\ = \U_PICSPI_Slave|cnt\(7) $ (!\U_PICSPI_Slave|cnt[6]~18\)
...
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	sdata => \U_PICSPI_Slave|byte_data_sent\(7),
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Motor_1|Equal0~0_combout\ = (!\Motor_1|clockcount\(3) & (!\Motor_1|clockcount\(1) & (!\Motor_1|clockcount\(0) & !\Motor_1|clockcount\(2))))
...
-- Equation(s):
-- \Motor_1|Equal0~1_combout\ = (\Motor_1|clockcount\(6) & (\Motor_1|Equal0~0_combout\ & (\Motor_1|clockcount\(5) & !\Motor_1|clockcount\(4))))
...
PORT MAP (
	...
	datab => \Motor_1|Equal0~0_combout\,
	datac => \Motor_1|clockcount\(5),
	datad => \Motor_1|clockcount\(4),
...
-- Equation(s):
-- \Motor_1|LessThan0~0_combout\ = (!\Motor_1|pulsecount\(11) & (!\Motor_1|pulsecount\(10) & !\Motor_1|pulsecount\(9)))
...
PORT MAP (
	...
	datac => \Motor_1|pulsecount\(10),
	datad => \Motor_1|pulsecount\(9),
...
-- Equation(s):
-- \counter[1]~7_combout\ = (counter(1) & (\current_State~regout\ $ (VCC))) # (!counter(1) & (\current_State~regout\ & VCC))
-- \counter[1]~8\ = CARRY((counter(1) & \current_State~regout\))
...
-- Equation(s):
-- \Motor_1|LessThan0~2_cout\ = CARRY((!\Motor_1|pulsecount\(0) & \pwm1[0]~7_combout\))
...
-- Equation(s):
-- \Motor_1|LessThan0~4_cout\ = CARRY((\pwm1[1]~6_combout\ & (\Motor_1|pulsecount\(1) & !\Motor_1|LessThan0~2_cout\)) # (!\pwm1[1]~6_combout\ & ((\Motor_1|pulsecount\(1)) # (!\Motor_1|LessThan0~2_cout\))))
...
-- Equation(s):
-- \Motor_1|LessThan0~8_cout\ = CARRY((\pwm1[3]~4_combout\ & (\Motor_1|pulsecount\(3) & !\Motor_1|LessThan0~6_cout\)) # (!\pwm1[3]~4_combout\ & ((\Motor_1|pulsecount\(3)) # (!\Motor_1|LessThan0~6_cout\))))
...
-- Equation(s):
-- \Motor_1|LessThan0~15_combout\ = (\pwm1[7]~0_combout\ & ((\Motor_1|LessThan0~14_cout\) # (!\Motor_1|pulsecount\(7)))) # (!\pwm1[7]~0_combout\ & (\Motor_1|LessThan0~14_cout\ & !\Motor_1|pulsecount\(7)))
...
-- pragma translate_on
PORT MAP (
	datab => \pwm1[7]~0_combout\,
	datad => \Motor_1|pulsecount\(7),
...
-- Equation(s):
-- \pwm2[7]~0_combout\ = (\Switch_1~combout\(1) & counter(7))
...
-- Equation(s):
-- \Motor_2|LessThan0~7_cout\ = CARRY((\pwm2[3]~4_combout\ & (\Motor_1|pulsecount\(3) & !\Motor_2|LessThan0~5_cout\)) # (!\pwm2[3]~4_combout\ & ((\Motor_1|pulsecount\(3)) # (!\Motor_2|LessThan0~5_cout\))))
...
-- Equation(s):
-- \Motor_2|LessThan0~11_cout\ = CARRY((\pwm2[5]~2_combout\ & (\Motor_1|pulsecount\(5) & !\Motor_2|LessThan0~9_cout\)) # (!\pwm2[5]~2_combout\ & ((\Motor_1|pulsecount\(5)) # (!\Motor_2|LessThan0~9_cout\))))
...
-- Equation(s):
-- \Motor_2|LessThan0~14_combout\ = (\pwm2[7]~0_combout\ & ((\Motor_2|LessThan0~13_cout\) # (!\Motor_1|pulsecount\(7)))) # (!\pwm2[7]~0_combout\ & (\Motor_2|LessThan0~13_cout\ & !\Motor_1|pulsecount\(7)))
...
-- Equation(s):
-- \Motor_3|LessThan0~13_cout\ = CARRY((\Motor_1|pulsecount\(6) & (\pwm3[6]~1_combout\ & !\Motor_3|LessThan0~11_cout\)) # (!\Motor_1|pulsecount\(6) & ((\pwm3[6]~1_combout\) # (!\Motor_3|LessThan0~11_cout\))))
...
-- Equation(s):
-- \Motor_3|LessThan0~14_combout\ = (\pwm3[7]~0_combout\ & ((\Motor_3|LessThan0~13_cout\) # (!\Motor_1|pulsecount\(7)))) # (!\pwm3[7]~0_combout\ & (!\Motor_1|pulsecount\(7) & \Motor_3|LessThan0~13_cout\))
...
-- Equation(s):
-- \pwm5[7]~0_combout\ = (counter(7) & \Switch_1~combout\(3))
...
-- Equation(s):
-- \pwm5[1]~6_combout\ = (counter(1) & \Switch_1~combout\(3))
...
-- Equation(s):
-- \Motor_5|LessThan0~5_cout\ = CARRY((\pwm5[2]~5_combout\ & ((!\Motor_5|LessThan0~3_cout\) # (!\Motor_1|pulsecount\(2)))) # (!\pwm5[2]~5_combout\ & (!\Motor_1|pulsecount\(2) & !\Motor_5|LessThan0~3_cout\)))
...
-- Equation(s):
-- \Motor_5|LessThan0~7_cout\ = CARRY((\pwm5[3]~4_combout\ & (\Motor_1|pulsecount\(3) & !\Motor_5|LessThan0~5_cout\)) # (!\pwm5[3]~4_combout\ & ((\Motor_1|pulsecount\(3)) # (!\Motor_5|LessThan0~5_cout\))))
...
-- Equation(s):
-- \Motor_5|LessThan0~13_cout\ = CARRY((\Motor_1|pulsecount\(6) & (\pwm5[6]~1_combout\ & !\Motor_5|LessThan0~11_cout\)) # (!\Motor_1|pulsecount\(6) & ((\pwm5[6]~1_combout\) # (!\Motor_5|LessThan0~11_cout\))))
...
PORT MAP (
	datab => \Motor_1|pulsecount\(8),
	datac => \Motor_5|LessThan0~14_combout\,

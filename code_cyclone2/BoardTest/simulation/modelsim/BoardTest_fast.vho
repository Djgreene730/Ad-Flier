...
-- Equation(s):
-- \pwm2[5]~2_combout\ = (counter(5) & \Switch_1~combout\(1))
...
-- Equation(s):
-- \U_1HzClkDivider|Equal0~1_combout\ = (!\U_1HzClkDivider|cnt\(0) & (\U_1HzClkDivider|cnt\(1) & (!\U_1HzClkDivider|cnt\(3) & \U_1HzClkDivider|cnt\(2))))
...
-- Equation(s):
-- \U_PICSPI_Slave|byte_data_sent~3_combout\ = (\U_PICSPI_Slave|byte_data_sent\(5) & (((\U_PICSPI_Slave|Equal2~0_combout\ & \U_PICSPI_Slave|cnt\(6))) # (!\U_PICSPI_Slave|byte_data_sent~0_combout\))) # (!\U_PICSPI_Slave|byte_data_sent\(5) & 
-- (\U_PICSPI_Slave|Equal2~0_combout\ & (\U_PICSPI_Slave|cnt\(6))))
...
-- Equation(s):
-- \U_1HzClkDivider|Equal0~2_combout\ = (!\U_1HzClkDivider|cnt\(8) & (\U_1HzClkDivider|cnt\(11) & (!\U_1HzClkDivider|cnt\(10) & !\U_1HzClkDivider|cnt\(9))))
...
-- Equation(s):
-- \U_1HzClkDivider|Equal0~3_combout\ = (!\U_1HzClkDivider|cnt\(13) & (!\U_1HzClkDivider|cnt\(12) & (!\U_1HzClkDivider|cnt\(14) & !\U_1HzClkDivider|cnt\(15))))
...
-- Equation(s):
-- \U_1HzClkDivider|Equal0~4_combout\ = (\U_1HzClkDivider|Equal0~1_combout\ & (\U_1HzClkDivider|Equal0~2_combout\ & (\U_1HzClkDivider|Equal0~3_combout\ & \U_1HzClkDivider|Equal0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_1HzClkDivider|Equal0~1_combout\,
...
-- Equation(s):
-- \U_1HzClkDivider|cnt~7_combout\ = (\U_1HzClkDivider|Add0~8_combout\ & ((!\U_1HzClkDivider|Equal0~6_combout\) # (!\U_1HzClkDivider|Equal0~4_combout\)))
...
-- Equation(s):
-- \U_1HzClkDivider|cnt~11_combout\ = (\U_1HzClkDivider|Add0~22_combout\ & ((!\U_1HzClkDivider|Equal0~6_combout\) # (!\U_1HzClkDivider|Equal0~4_combout\)))
...
-- Equation(s):
-- \Motor_1|Equal0~0_combout\ = (!\Motor_1|clockcount\(2) & (!\Motor_1|clockcount\(3) & (!\Motor_1|clockcount\(1) & !\Motor_1|clockcount\(0))))
...
PORT MAP (
	dataa => \Motor_1|clockcount\(2),
	datab => \Motor_1|clockcount\(3),
	datac => \Motor_1|clockcount\(1),
	datad => \Motor_1|clockcount\(0),
...
-- Equation(s):
-- \Motor_1|Equal0~1_combout\ = (\Motor_1|clockcount\(6) & (!\Motor_1|clockcount\(4) & (\Motor_1|Equal0~0_combout\ & \Motor_1|clockcount\(5))))
...
PORT MAP (
	...
	datac => \Motor_1|Equal0~0_combout\,
	datad => \Motor_1|clockcount\(5),
...
-- Equation(s):
-- \pwm2[4]~3_combout\ = (counter(4) & \Switch_1~combout\(1))
...
-- Equation(s):
-- \pwm3[6]~1_combout\ = (counter(6) & \Switch_1~combout\(2))
...
-- Equation(s):
-- \Motor_3|LessThan0~9_cout\ = CARRY((\pwm3[4]~3_combout\ & ((!\Motor_3|LessThan0~7_cout\) # (!\Motor_1|pulsecount\(4)))) # (!\pwm3[4]~3_combout\ & (!\Motor_1|pulsecount\(4) & !\Motor_3|LessThan0~7_cout\)))
...
-- Equation(s):
-- \Motor_3|LessThan0~14_combout\ = (\pwm3[7]~0_combout\ & ((\Motor_3|LessThan0~13_cout\) # (!\Motor_1|pulsecount\(7)))) # (!\pwm3[7]~0_combout\ & (\Motor_3|LessThan0~13_cout\ & !\Motor_1|pulsecount\(7)))
...
-- Equation(s):
-- \Motor_5|LessThan0~3_cout\ = CARRY((\pwm5[1]~6_combout\ & (\Motor_1|pulsecount\(1) & !\Motor_5|LessThan0~1_cout\)) # (!\pwm5[1]~6_combout\ & ((\Motor_1|pulsecount\(1)) # (!\Motor_5|LessThan0~1_cout\))))
...
-- Equation(s):
-- \Motor_5|LessThan0~11_cout\ = CARRY((\pwm5[5]~2_combout\ & (\Motor_1|pulsecount\(5) & !\Motor_5|LessThan0~9_cout\)) # (!\pwm5[5]~2_combout\ & ((\Motor_1|pulsecount\(5)) # (!\Motor_5|LessThan0~9_cout\))))
